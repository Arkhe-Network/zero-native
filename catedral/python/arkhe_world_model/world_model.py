...
class WorldModelEmbryo(nn.Module):
    ...
    def __init__(self, config: Optional[WorldModelConfig] = None):
        ...
        # Note: Para que o PyTorch registre os parâmetros de submódulos criados lazyly,
        # precisamos garantir que eles sejam instanciados se forem necessários na maturidade atual.
        # Caso contrário, model.parameters() estará vazio na inicialização.
        # Nós usamos getattr para acionar a criação lazy dos módulos ativos na inicialização.
    ...
    def physics_priors(self):
        if self._physics_priors is None:
            ...
            self.add_module("physics_priors_module", self._physics_priors)
    ...
    def multimodal_fusion(self):
        if self._multimodal_fusion is None:
            ...
            self.add_module("multimodal_fusion_module", self._multimodal_fusion)
    ...
    def self_model(self):
        if self._self_model is None:
            ...
            self.add_module("self_model_module", self._self_model)
