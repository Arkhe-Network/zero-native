- **Enterprise Architecture** – Model complex hybrid infrastructures as hypergraphs (905), reason over them with OWL (920), and seal architectural decisions immutably (912).
